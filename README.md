...
본 레포지토리에 사용된 일부 소스(이미지나 음원)의 저작권은 휴투에 있습니다. 본 레포지토리의 음원을 사용하지 마시고 원작 레포지토리를 사용하시길 바랍니다.
(일부 음원-a hisa)

본 소스엔 타 게임 룰 등 외부 소스가 동봉되어 있습니다.

문의하실 점이나 수정이 필요한 부분은 twhyusan@tensi.org로 문의 주시면 신속하게 처리하겠습니다!

본 소스코드는 2019.08.12일자로 업데이트 되었습니다.
